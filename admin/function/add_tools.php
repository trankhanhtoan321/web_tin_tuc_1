<div class="header">Viết Bài code tools</div>
<?php
if(isset($_POST['submit_tools']))
{
	if(!@fopen("../tools/".$_POST['file_name'],"r"))
	{
		$f=fopen("../tools/".$_POST['file_name'],"w");
...
?>
	...
	Tên file php (dạng file.php) : 
		<input type="text" name="file_name"/><br/>
	<b>Description:</b><br/>
		<textarea name="des"></textarea><br/>
	<b>Content:</b><br/>
		<textarea style="height:500px;width:100%" name="content"></textarea><br/>
		<input type="submit" name="submit_tools" value="POST"/>
</form>