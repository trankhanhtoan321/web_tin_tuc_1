...
$mail->SMTPSecure = "tls"; 
$mail->SMTPAuth   = true;
$mail->Username   = "trankhanhtoan321@gmail.com"; 
$mail->Password   = "tkt12355880";
$mail->SetFrom("TranKhanhToan321@gmail.com", "Tuyền Beauty Shop");
$mail->AddReplyTo("TranKhanhToan321@gmail.com","Tuyền Beauty Shop");
$mail->Subject = "Hóa Đơn Đặt Hàng : ".$name;
$mail->AltBody = "Hóa Đơn Đặt Hàng : ".$name;
$mail->MsgHTML($dathang);
$mail->AddAddress($email,$name);//người nhận mail
$kt=$mail->Send();
/////////////////////////////////////////////
if($kt) return "ok";
else return "error";
